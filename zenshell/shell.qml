...
Scope {
    ...
    function applyTheme(themeId) {
        ...
        updateThemeAccent();
        applyThemeProcess.command = ["bash", Quickshell.env("HOME") + "/scripts/theme-switch.sh", themeId];
    ...
    Process {
        ...
        command: ["cat", Quickshell.env("HOME") + "/.config/hypr/themes/current_theme.conf"]
        running: true
        stdout: SplitParser {
            onRead: data => {
